          ...
          {user?.role === "admin" && (
            <>
              ...
              <Collapse in={openFlowerType} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    sx={{ pl: 4 }}
                    selected={
                      location.pathname === "/admin/flower-types/colors"
                    }>
                    <ListItemIcon sx={{ color: "green" }}>
                      <ColorLens />
                    </ListItemIcon>
              ...
              <Collapse in={openDiscount} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem
                    ...
                    sx={{ pl: 4 }}
                    selected={
                      location.pathname === "/admin/discounts/subscribers"
                    }>
                    <ListItemIcon sx={{ color: "green" }}>
                      <People />
                    </ListItemIcon>
                    <ListItemText
                      primary="Người đăng ký"
                      sx={{
                        "&.Mui-selected, &.Mui-selected:hover": {
                          bgcolor: "#e0f2f1",
                          color: "black",
              ...
              <ListItem
                ...
                component={Link}
                to="/admin/messages"
                selected={location.pathname.startsWith("/admin/messages")}
                sx={{
                  "&.Mui-selected, &.Mui-selected:hover": {
                    bgcolor: "#e0f2f1",
                    color: "black",
                ...
                <ListItemText primary="Quản lý tin nhắn" />
              </ListItem>
